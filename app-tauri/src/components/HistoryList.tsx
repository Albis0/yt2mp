            ...
            >
              ...
              <span className="history-text">
                ...
                <span className="history-sub">
                  ...
                  {/* Items saved before multi-platform support have no
                      platform recorded — show nothing rather than guessing. */}
                  {item.platform ? (
                    <span className={`history-platform platform-${item.platform}`}>
